...
const Services = () => {
    return (
        <>
            <div className='py-10 my-32 container mx-auto'>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    <div data-wow-delay="1.7s" className='wow animate__animated animate__fadeInUp flex hover:shadow-xl rounded-md items-start group border p-5 border-white dark:border-transparent dark:hover:border-[#243763] normal-transition'>
                    ...
                    <div data-wow-delay="2.2s" className='wow animate__animated animate__fadeInUp flex hover:shadow-xl rounded-md items-start group border p-5 border-white dark:border-transparent dark:hover:border-[#243763] normal-transition'>
                        <div className='flex justify-center items-center rounded-full bg-purple-200 dark:bg-darkLight normal-transition px-4 py-3'>
                    ...
                    <div data-wow-delay="2.7s" className='wow animate__animated animate__fadeInUp flex hover:shadow-xl rounded-md items-start group border p-5 border-white dark:border-transparent dark:hover:border-[#243763] normal-transition'>
                        <div className='flex justify-center items-center rounded-full bg-purple-200 dark:bg-darkLight normal-transition px-4 py-3'>
                    ...
                    <div data-wow-delay="3.2s" className='wow animate__animated animate__fadeInUp flex hover:shadow-xl rounded-md items-start group border p-5 border-white dark:border-transparent dark:hover:border-[#243763] normal-transition'>
                        <div className='flex justify-center items-center rounded-full bg-purple-200 dark:bg-darkLight normal-transition px-4 py-3'>
